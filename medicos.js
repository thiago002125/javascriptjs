...
function insertMedico(nome, email, especialidade) {
...
function editMedico(id, nome, email, especialidade) {
...
function submeter(e) {
    ...
    if(data.id) {
        editMedico(data.id, data.nome, data.email, data.especialidade)
    }
    else {
        insertMedico(data.nome, data.email, data.especialidade)
    }
}
